...
var client = new FeatureFlagsClient(httpClient, new FeatureFlagsClientOptions
{
...
{
    Console.WriteLine("FeatureFlags.Sample.Console\n");
    Console.WriteLine("A valid JWT Bearer Token is required to acquire an API Key - refer to the docs\n");
    Console.WriteLine("Usage:");
    Console.WriteLine(
        "  dotnet run --project samples/FeatureFlags.Sample.Console -- --baseUrl=https://localhost:5000/api/ --apiKey=ffsk_... --flagKey=my-flag\n");
