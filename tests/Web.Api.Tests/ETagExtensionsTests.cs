...
public class ETagExtensionsTests
{
    ...
    {
        // Arrange
        var featureFlag = new FeatureFlagResponse
        {
    ...
    public void GenerateETag_SameFeatureFlagVersions_ShouldProduceSameETag()
    {
        // Arrange
        var id = Guid.NewGuid();
        var flag1 = new FeatureFlagResponse { Id = id, Version = 1 };
        var flag2 = new FeatureFlagResponse { Id = id, Version = 1 };
    ...
    public void GenerateETag_DifferentVersions_ShouldProduceDifferentETags()
    {
        ...
        var id = Guid.NewGuid();
        var flag1 = new FeatureFlagResponse { Id = id, Version = 1 };
        var flag2 = new FeatureFlagResponse { Id = id, Version = 2 };
