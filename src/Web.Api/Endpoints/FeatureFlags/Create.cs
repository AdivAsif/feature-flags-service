...
public class Create : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPost("/feature-flags",
                async (CreateFeatureFlagRequest featureFlag, HttpContext httpContext, ClaimsPrincipal user,
                    ...
                    ILogger<Create> logger) =>
                {
                    ...
                    {
                        logger.LogError(ex, "An error occurred while creating feature flag by key: {Key}",
                            featureFlag.Key);
